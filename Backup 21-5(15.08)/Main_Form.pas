...
begin
  ...
  begin
    ...
    begin
      ...
      ParamString := '/e:on /k "c:\progra~1\mcs\setpath794.bat" /C Title ' + Project + ' & cd "' + ExtractFilePath(Filename) + '" & "' + ExtractFileName(Filename) + '" | tee "' + Project + '.txt"'; //title, filepath, filename, echofile
